...
O projeto em questão foi feito baseado no curso da Alura "Javascript - construindo páginas dinâmicas". Adicionei o fato do item da lista ser removido após ser retirado da lista